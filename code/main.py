...
WORK_START_HOUR = int(os.getenv('WORK_START_HOUR'))  # 8 AM EST
WORK_START_MIN = int(os.getenv('WORK_START_MIN'))
WORK_END_HOUR = int(os.getenv('WORK_END_HOUR'))  # 8 PM EST
WORK_END_MIN = int(os.getenv('WORK_END_MIN'))
